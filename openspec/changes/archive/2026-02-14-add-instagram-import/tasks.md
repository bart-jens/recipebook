...
- [x] 6.3 Add `ANTHROPIC_API_KEY` to Vercel environment variables *(manual — user action)*
- [x] 6.4 Test end-to-end: paste caption → review → save, upload image → review → save *(manual — user action)*
