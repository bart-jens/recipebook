...
Chef discovery allows users to find and follow other Chefs on the platform. The Chefs tab on the Discover page surfaces all users, sorted by recent activity, with inline follow actions and an invite CTA.
