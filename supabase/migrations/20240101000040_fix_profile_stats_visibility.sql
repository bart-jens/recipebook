-- Fix get_chef_profile: Stats bar counts ALL recipes/cook_logs regardless of
-- visibility, while tabs correctly filter by visibility. This makes stats
-- show inflated numbers (e.g. "6 recipes" when all are private and the
-- Recipes tab shows 0). Apply same visibility logic to stats.
...
begin
  ...
  -- Stats: recipe_count and cook_count are visibility-aware.
