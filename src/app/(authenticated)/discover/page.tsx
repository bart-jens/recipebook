...
export default async function DiscoverPage({
  ...
  if (q) {
    ...
    const [{ data: rpcIds }, { data: tagMatches }] = await Promise.all([
      supabase.rpc("search_public_recipes_by_ingredient", { query: q }),
  ...
  return (
    <div>
      ...
      <div className="px-5 pt-4 animate-fade-in-up opacity-0 anim-delay-1">
        <div className="text-[11px] font-normal tracking-[0.02em] text-ink-muted mb-1">Community</div>
        <h1 className="text-[36px] font-light tracking-[-0.03em] mb-3.5">Discover</h1>
      </div>
