  ...
  return (
    <div className="space-y-2">
        ...
        <div key={i} className="flex flex-col gap-2 rounded-md border border-gray-200 p-3">
          <div className="flex gap-2">
            <input
              ...
              className="w-20 rounded-md border border-gray-300 px-2 py-3 text-base"
            />
            <input
              type="text"
              placeholder="Unit"
              ...
              className="w-24 rounded-md border border-gray-300 px-2 py-3 text-base"
            />
            <input
              type="text"
              ...
              className="flex-1 rounded-md border border-gray-300 px-2 py-3 text-base"
            />
          </div>
          <div className="flex gap-2">
            <input
      ...
      <button
        type="button"
        onClick={add}
        className="rounded-md border border-dashed border-gray-300 px-4 py-3 text-sm text-gray-600 hover:bg-gray-50 w-full"
      >
        + Add ingredient
      </button>
    </div>
