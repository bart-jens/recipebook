  ...
  return (
    <div className="mt-12 border-t border-warm-border pt-8">
      ...
      <button
        ...
        disabled={isDeleting}
        className="mt-4 rounded-md border border-red-300 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 active:scale-[0.98] transition-all disabled:opacity-50"
      >
